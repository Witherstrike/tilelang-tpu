...
def swi_glu(Block_w, Block_c, C, W, dtype="bfloat16", accum_dtype="float32"):
    ...
    @T.prim_func
    def main_kernel_inner(G_in: T.Tensor(global_shape,
                                         dtype), G_right: T.Tensor(global_shape, dtype),
...
kernel = tilelang.compile(
    swi_glu(32, 32, 64, 64), out_idx=-1, target="tpu -mcpu=bm1690 -tpu-programming-model=tpukernel")
