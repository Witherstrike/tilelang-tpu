module attributes {module.chip = "tpub_7_1_e_rv"} {
  func.func @_Z11fill_kernelP4fp16(%arg0: memref<?xf16> {ppl.vname = "out"}) attributes {BlockNum = 1 : i32, GroupNum = 1 : i32, category = "kernel", ori_name = "fill_kernel"} {
    ...
    %1 = ppl.tensorfe GLOBAL %0, %arg0 {address = -1 : i64, align_mode = 0 : i64, ppl.vname = "g_out"} : tensor<1x4xi32>, memref<?xf16> -> memref<?xf16>
    %2 = "ppl.none"() : () -> none
    %3 = ppl.tensorfe LOCAL %0, %2 {address = -1 : i64, align_mode = 1 : i64, ppl.vname = "local"} : tensor<1x4xi32>, none -> memref<?xf16>
    %4 = ppl.scalar %cst : f32 -> f16
    ppl.tiu.set_C %3, %4 : memref<?xf16>, f16
