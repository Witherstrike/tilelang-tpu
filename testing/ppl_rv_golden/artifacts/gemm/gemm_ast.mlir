module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<"dlti.endianness", "little">, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  ...
  func.func @_Z11gemm_kernelP4fp16S0_S0_(%arg0: memref<?xf16> {ppl.vname = "out"}, %arg1: memref<?xf16> {ppl.vname = "lhs"}, %arg2: memref<?xf16> {ppl.vname = "rhs"}) attributes {category = "kernel", ori_name = "gemm_kernel"} {
    ...
    %alloca_0 = memref.alloca() {ppl.vname = "r"} : memref<1x1xmemref<?xf16>>
    %cast_1 = memref.cast %alloca_0 : memref<1x1xmemref<?xf16>> to memref<?x1xmemref<?xf16>>
    %alloca_2 = memref.alloca() {ppl.vname = "l"} : memref<1x1xmemref<?xf16>>
    %cast_3 = memref.cast %alloca_2 : memref<1x1xmemref<?xf16>> to memref<?x1xmemref<?xf16>>
    %alloca_4 = memref.alloca() {ppl.vname = "g_out"} : memref<1x1xmemref<?xf16>>
    %cast_5 = memref.cast %alloca_4 : memref<1x1xmemref<?xf16>> to memref<?x1xmemref<?xf16>>
    %alloca_6 = memref.alloca() {ppl.vname = "g_rhs"} : memref<1x1xmemref<?xf16>>
    %cast_7 = memref.cast %alloca_6 : memref<1x1xmemref<?xf16>> to memref<?x1xmemref<?xf16>>
    %alloca_8 = memref.alloca() {ppl.vname = "g_lhs"} : memref<1x1xmemref<?xf16>>
    %cast_9 = memref.cast %alloca_8 : memref<1x1xmemref<?xf16>> to memref<?x1xmemref<?xf16>>
    %alloca_10 = memref.alloca() {ppl.vname = "out_shape"} : memref<1x4xi32>
    %cast_11 = memref.cast %alloca_10 : memref<1x4xi32> to memref<?x4xi32>
    %alloca_12 = memref.alloca() {ppl.vname = "rhs_shape"} : memref<1x4xi32>
    %cast_13 = memref.cast %alloca_12 : memref<1x4xi32> to memref<?x4xi32>
    %alloca_14 = memref.alloca() {ppl.vname = "lhs_shape"} : memref<1x4xi32>
    %cast_15 = memref.cast %alloca_14 : memref<1x4xi32> to memref<?x4xi32>
    call @_ZN3ppl4dim4C1Eiiii(%cast_15, %c1_i32, %c16_i32, %c1_i32, %c16_i32) {ori_name = "dim4"} : (memref<?x4xi32>, i32, i32, i32, i32) -> ()
    call @_ZN3ppl4dim4C1Eiiii(%cast_13, %c1_i32, %c16_i32, %c1_i32, %c16_i32) {ori_name = "dim4"} : (memref<?x4xi32>, i32, i32, i32, i32) -> ()
    call @_ZN3ppl4dim4C1Eiiii(%cast_11, %c1_i32, %c16_i32, %c1_i32, %c16_i32) {ori_name = "dim4"} : (memref<?x4xi32>, i32, i32, i32, i32) -> ()
    call @_ZN3ppl7gtensorI4fp16EC1IRNS_4dim4EEEOT_13tensor_mode_tPS1_(%cast_9, %cast_15, %c2_i32, %arg1) {ori_name = "gtensor"} : (memref<?x1xmemref<?xf16>>, memref<?x4xi32>, i32, memref<?xf16>) -> ()
    call @_ZN3ppl7gtensorI4fp16EC1IRNS_4dim4EEEOT_13tensor_mode_tPS1_(%cast_7, %cast_13, %c2_i32, %arg2) {ori_name = "gtensor"} : (memref<?x1xmemref<?xf16>>, memref<?x4xi32>, i32, memref<?xf16>) -> ()
    call @_ZN3ppl7gtensorI4fp16EC1IRNS_4dim4EEEOT_13tensor_mode_tPS1_(%cast_5, %cast_11, %c2_i32, %arg0) {ori_name = "gtensor"} : (memref<?x1xmemref<?xf16>>, memref<?x4xi32>, i32, memref<?xf16>) -> ()
    call @_ZN3ppl6tensorI4fp16EC1IRNS_4dim4EEEOT_12align_mode_tx(%cast_3, %cast_15, %c1_i32, %c-1_i64) {ori_name = "tensor"} : (memref<?x1xmemref<?xf16>>, memref<?x4xi32>, i32, i64) -> ()
    ...
    call @_ZN3ppl6tensorI4fp16EC1IRNS_4dim4EEEOT_12align_mode_tx(%cast, %cast_11, %c1_i32, %c-1_i64) {ori_name = "tensor"} : (memref<?x1xmemref<?xf16>>, memref<?x4xi32>, i32, i64) -> ()
    ...
    call @_ZN3ppl3dma4loadI4fp16EEvRNS_6tensorIT_EERNS_7gtensorIS4_EE(%cast_1, %cast_7) {ori_name = "load"} : (memref<?x1xmemref<?xf16>>, memref<?x1xmemref<?xf16>>) -> ()
    call @_ZN3ppl3tiu7fmm2_nnI4fp16NS_6tensorIS2_EES4_EEvRNS3_IT_EERT0_RT1_b(%cast, %cast_3, %cast_1, %false) {ori_name = "fmm2_nn"} : (memref<?x1xmemref<?xf16>>, memref<?x1xmemref<?xf16>>, memref<?x1xmemref<?xf16>>, i1) -> ()
    call @_ZN3ppl3dma5storeI4fp16EEvRNS_7gtensorIT_EERNS_6tensorIS4_EE(%cast_5, %cast) {ori_name = "store"} : (memref<?x1xmemref<?xf16>>, memref<?x1xmemref<?xf16>>) -> ()
    return
  }
  ...
  func.func @_ZN3ppl3tiu7fmm2_nnI4fp16NS_6tensorIS2_EES4_EEvRNS3_IT_EERT0_RT1_b(%arg0: memref<?x1xmemref<?xf16>> {ppl.vname = "dst"}, %arg1: memref<?x1xmemref<?xf16>> {ppl.vname = "left"}, %arg2: memref<?x1xmemref<?xf16>> {ppl.vname = "right"}, %arg3: i1 {ppl.vname = "result_add"}) attributes {llvm.linkage = #llvm.linkage<linkonce_odr>, ori_name = "fmm2_nn", unsignedIdx = [3 : index]} {
    %cst = arith.constant 1.000000e+00 : f32
    %false = arith.constant {ppl.vname = "do_relu"} false
    %c0_i32 = arith.constant {ppl.vname = "bias"} 0 : i32
    %alloca = memref.alloca() {ppl.vname = "bias"} : memref<1xi32>
    %cast = memref.cast %alloca : memref<1xi32> to memref<?xi32>
    affine.store %c0_i32, %alloca[0] : memref<1xi32>
    call @_ZN3ppl3tiu7fmm2_nnI4fp16NS_6tensorIS2_EES4_ifEEvRNS3_IT_EERT0_RT1_RT2_b11data_type_tbbT3_(%arg0, %arg1, %arg2, %cast, %arg3, %c0_i32, %false, %false, %cst) {ori_name = "fmm2_nn"} : (memref<?x1xmemref<?xf16>>, memref<?x1xmemref<?xf16>>, memref<?x1xmemref<?xf16>>, memref<?xi32>, i1, i32, i1, i1, f32) -> ()
    return
  }
  ...
  func.func private @_ZN3ppl3tiu7fmm2_nnI4fp16NS_6tensorIS2_EES4_ifEEvRNS3_IT_EERT0_RT1_RT2_b11data_type_tbbT3_(memref<?x1xmemref<?xf16>> {ppl.vname = "dst"}, memref<?x1xmemref<?xf16>> {ppl.vname = "left"}, memref<?x1xmemref<?xf16>> {ppl.vname = "right"}, memref<?xi32> {ppl.vname = "bias"}, i1 {ppl.vname = "result_add"}, i32 {ppl.vname = "out_dtype"}, i1 {ppl.vname = "do_relu"}, i1 {ppl.vname = "saturate"}, f32 {ppl.vname = "requant"}) attributes {ori_name = "fmm2_nn", unsignedIdx = [4 : index, 5 : index, 6 : index, 7 : index]}
}
