module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<"dlti.endianness", "little">, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  ...
  func.func @_Z16reduction_kernelP4fp16S0_(%arg0: memref<?xf16> {ppl.vname = "out"}, %arg1: memref<?xf16> {ppl.vname = "in"}) attributes {category = "kernel", ori_name = "reduction_kernel"} {
    ...
    %alloca = memref.alloca() {ppl.vname = "local_out"} : memref<1x1xmemref<?xf16>>
    %cast = memref.cast %alloca : memref<1x1xmemref<?xf16>> to memref<?x1xmemref<?xf16>>
    %alloca_0 = memref.alloca() {ppl.vname = "local_in"} : memref<1x1xmemref<?xf16>>
    %cast_1 = memref.cast %alloca_0 : memref<1x1xmemref<?xf16>> to memref<?x1xmemref<?xf16>>
    %alloca_2 = memref.alloca() {ppl.vname = "g_out"} : memref<1x1xmemref<?xf16>>
    %cast_3 = memref.cast %alloca_2 : memref<1x1xmemref<?xf16>> to memref<?x1xmemref<?xf16>>
    %alloca_4 = memref.alloca() {ppl.vname = "g_in"} : memref<1x1xmemref<?xf16>>
    %cast_5 = memref.cast %alloca_4 : memref<1x1xmemref<?xf16>> to memref<?x1xmemref<?xf16>>
    %alloca_6 = memref.alloca() {ppl.vname = "out_shape"} : memref<1x4xi32>
    %cast_7 = memref.cast %alloca_6 : memref<1x4xi32> to memref<?x4xi32>
    %alloca_8 = memref.alloca() {ppl.vname = "in_shape"} : memref<1x4xi32>
    %cast_9 = memref.cast %alloca_8 : memref<1x4xi32> to memref<?x4xi32>
    call @_ZN3ppl4dim4C1Eiiii(%cast_9, %c1_i32, %c8_i32, %c1_i32, %c16_i32) {ori_name = "dim4"} : (memref<?x4xi32>, i32, i32, i32, i32) -> ()
    call @_ZN3ppl4dim4C1Eiiii(%cast_7, %c1_i32, %c8_i32, %c1_i32, %c1_i32) {ori_name = "dim4"} : (memref<?x4xi32>, i32, i32, i32, i32) -> ()
    call @_ZN3ppl7gtensorI4fp16EC1IRNS_4dim4EEEOT_13tensor_mode_tPS1_(%cast_5, %cast_9, %c2_i32, %arg1) {ori_name = "gtensor"} : (memref<?x1xmemref<?xf16>>, memref<?x4xi32>, i32, memref<?xf16>) -> ()
    call @_ZN3ppl7gtensorI4fp16EC1IRNS_4dim4EEEOT_13tensor_mode_tPS1_(%cast_3, %cast_7, %c2_i32, %arg0) {ori_name = "gtensor"} : (memref<?x1xmemref<?xf16>>, memref<?x4xi32>, i32, memref<?xf16>) -> ()
    call @_ZN3ppl6tensorI4fp16EC1IRNS_4dim4EEEOT_12align_mode_tx(%cast_1, %cast_9, %c1_i32, %c-1_i64) {ori_name = "tensor"} : (memref<?x1xmemref<?xf16>>, memref<?x4xi32>, i32, i64) -> ()
    call @_ZN3ppl6tensorI4fp16EC1IRNS_4dim4EEEOT_12align_mode_tx(%cast, %cast_7, %c1_i32, %c-1_i64) {ori_name = "tensor"} : (memref<?x1xmemref<?xf16>>, memref<?x4xi32>, i32, i64) -> ()
    call @_ZN3ppl3dma4loadI4fp16EEvRNS_6tensorIT_EERNS_7gtensorIS4_EE(%cast_1, %cast_5) {ori_name = "load"} : (memref<?x1xmemref<?xf16>>, memref<?x1xmemref<?xf16>>) -> ()
    call @_ZN3ppl3tiu6reduceI4fp16S2_EEvRNS_6tensorIT_EERNS3_IT0_EE19all_reduce_opcode_tb(%cast, %cast_1, %c6_i32, %false) {ori_name = "reduce"} : (memref<?x1xmemref<?xf16>>, memref<?x1xmemref<?xf16>>, i32, i1) -> ()
    call @_ZN3ppl3dma5storeI4fp16EEvRNS_7gtensorIT_EERNS_6tensorIS4_EE(%cast_3, %cast) {ori_name = "store"} : (memref<?x1xmemref<?xf16>>, memref<?x1xmemref<?xf16>>) -> ()
    return
  }
  ...
  func.func private @_ZN3ppl3tiu6reduceI4fp16S2_EEvRNS_6tensorIT_EERNS3_IT0_EE19all_reduce_opcode_tb(memref<?x1xmemref<?xf16>> {ppl.vname = "dst"}, memref<?x1xmemref<?xf16>> {ppl.vname = "src"}, i32 {ppl.vname = "opcode"}, i1 {ppl.vname = "saturation"}) attributes {ori_name = "reduce", unsignedIdx = [2 : index, 3 : index]}
