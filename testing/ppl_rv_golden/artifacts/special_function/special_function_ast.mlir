module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<"dlti.endianness", "little">, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  ...
  func.func @_Z23special_function_kernelP4fp16S0_(%arg0: memref<?xf16> {ppl.vname = "out"}, %arg1: memref<?xf16> {ppl.vname = "in"}) attributes {category = "kernel", ori_name = "special_function_kernel"} {
    ...
    %alloca_6 = memref.alloca() {ppl.vname = "shape"} : memref<1x4xi32>
    %cast_7 = memref.cast %alloca_6 : memref<1x4xi32> to memref<?x4xi32>
    call @_ZN3ppl4dim4C1Eiiii(%cast_7, %c1_i32, %c8_i32, %c1_i32, %c16_i32) {ori_name = "dim4"} : (memref<?x4xi32>, i32, i32, i32, i32) -> ()
    call @_ZN3ppl7gtensorI4fp16EC1IRNS_4dim4EEEOT_13tensor_mode_tPS1_(%cast_5, %cast_7, %c2_i32, %arg1) {ori_name = "gtensor"} : (memref<?x1xmemref<?xf16>>, memref<?x4xi32>, i32, memref<?xf16>) -> ()
    ...
    call @_ZN3ppl6tensorI4fp16EC1IRNS_4dim4EEEOT_12align_mode_tx(%cast_1, %cast_7, %c1_i32, %c-1_i64) {ori_name = "tensor"} : (memref<?x1xmemref<?xf16>>, memref<?x4xi32>, i32, i64) -> ()
    ...
    call @_ZN3ppl3tiu6frsqrtI4fp16EEvRNS_6tensorIT_EES6_i(%cast, %cast_1, %c3_i32) {ori_name = "frsqrt"} : (memref<?x1xmemref<?xf16>>, memref<?x1xmemref<?xf16>>, i32) -> ()
  ...
  func.func private @_ZN3ppl3tiu6frsqrtI4fp16EEvRNS_6tensorIT_EES6_i(memref<?x1xmemref<?xf16>> {ppl.vname = "dst"}, memref<?x1xmemref<?xf16>> {ppl.vname = "src"}, i32 {ppl.vname = "num_iter"}) attributes {ori_name = "frsqrt"}
