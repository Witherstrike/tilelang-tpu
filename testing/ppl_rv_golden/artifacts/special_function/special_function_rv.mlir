module attributes {module.chip = "tpub_7_1_e_rv"} {
  func.func @_Z23special_function_kernelP4fp16S0_(%arg0: memref<?xf16> {ppl.vname = "out"}, %arg1: memref<?xf16> {ppl.vname = "in"}) attributes {AddressAssigned = true, BlockNum = 1 : i32, GroupNum = 1 : i32, bank_bytes = 16384 : i64, bank_num = 16 : i64, calc_liverange = true, category = "kernel", dyn_block = false, lmem_size = 262144 : i64, ori_name = "special_function_kernel", tensor_idx_begin = 2 : i64, tensor_num = 2 : i64} {
    ...
    ppl_rv.dmaload %c9_i32, %c32_i32 {loc = 0 : i32} : i32, i32
    ppl_rv.reg_rsqrt_iter %c3_i32 : i32
    ppl_rv.rsqrt %c8_i32, %c9_i32 : i32, i32
    ppl_rv.dmastore %c33_i32, %c8_i32 {loc = 2 : i32} : i32, i32
    return
  }
}
