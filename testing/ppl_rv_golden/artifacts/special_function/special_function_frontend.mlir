module attributes {module.chip = "tpub_7_1_e_rv"} {
  func.func @_Z23special_function_kernelP4fp16S0_(%arg0: memref<?xf16> {ppl.vname = "out"}, %arg1: memref<?xf16> {ppl.vname = "in"}) attributes {BlockNum = 1 : i32, GroupNum = 1 : i32, category = "kernel", ori_name = "special_function_kernel"} {
    ...
    %1 = ppl.tensorfe GLOBAL %0, %arg1 {address = -1 : i64, align_mode = 0 : i64, ppl.vname = "g_in"} : memref<1x4xi32>, memref<?xf16> -> memref<?xf16>
    %2 = ppl.tensorfe GLOBAL %0, %arg0 {address = -1 : i64, align_mode = 0 : i64, ppl.vname = "g_out"} : memref<1x4xi32>, memref<?xf16> -> memref<?xf16>
    %3 = "ppl.none"() : () -> none
    %4 = ppl.tensorfe LOCAL %0, %3 {address = -1 : i64, align_mode = 1 : i64, ppl.vname = "local_in"} : memref<1x4xi32>, none -> memref<?xf16>
    %5 = ppl.tensorfe LOCAL %0, %3 {address = -1 : i64, align_mode = 1 : i64, ppl.vname = "local_out"} : memref<1x4xi32>, none -> memref<?xf16>
